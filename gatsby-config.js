...
//get `de` description for manifest locale
const siteDescriptionDE = configLanguages.filter(item => item.key === `de`)[0].siteDescription
      ...
      options: {
        ...
        localize: [
          ...
          },
          {
            start_url: `/de/`,
            lang: `de`,
            name: `Vidyaa - Gatsby theme DE`,
            short_name: `Vidyaa`,
            description: siteDescriptionDE,
          },
        ],
      },
    },
